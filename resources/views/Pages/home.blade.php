                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                ...
                                                <a href="{{url('#')}}" class="link-secondary text-decoration-underline">View net
                                                    earnings</a>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                ...
                                                <a href="{{url('#')}}" class="link-secondary text-decoration-underline">View all
                                                    orders</a>
                                            </div>
                                            <div class="avatar-sm flex-shrink-0">
                                                <span class="avatar-title bg-primary-subtle rounded fs-3">
                                    ...
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="dropdown card-header-dropdown">
                                                <a class="text-reset dropdown-btn" href="{{url('#')}}" data-bs-toggle="dropdown"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{url('#')}}">Today</a>
                                                    <a class="dropdown-item" href="{{url('#')}}">Yesterday</a>
                                                    <a class="dropdown-item" href="{{url('#')}}">Last 7 Days</a>
                                                    <a class="dropdown-item" href="{{url('#')}}">Last 30 Days</a>
                                                    <a class="dropdown-item" href="{{url('#')}}">This Month</a>
                                                    <a class="dropdown-item" href="{{url('#')}}">Last Month</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-14 my-1">
                                                                        <a href="{{url('apps-ecommerce-product-details.html')}}"
                                        ...
                                        <div
                                            ...
                                            <div class="col-sm-auto mt-3 mt-sm-0">
                                                <ul
                                                    ...
                                                    <li class="page-item">
                                                        <a href="{{url('#')}}" class="page-link">1</a>
                                                    </li>
                                                    <li class="page-item active">
                                                        <a href="{{url('#')}}" class="page-link">2</a>
                                                    </li>
                                                    <li class="page-item">
                                                        <a href="{{url('#')}}" class="page-link">3</a>
                                                    </li>
                                                    <li class="page-item">
                                                        <a href="{{url('#')}}" class="page-link">→</a>
                                                    </li>
                                    ...
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="dropdown card-header-dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{url('#')}}">Download Report</a>
                                                    <a class="dropdown-item" href="{{url('#')}}">Export</a>
                                                    <a class="dropdown-item" href="{{url('#')}}">Import</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-14 my-1 fw-medium">
                                                                        <a href="{{url('apps-ecommerce-seller-details.html')}}"
                                        ...
                                        <div class="table-responsive table-card">
                                            <table
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <a href="{{url('apps-ecommerce-order-details.html')}}"
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-3 mt-2">
                                    ...
                                    <ol class="ps-3 text-muted">
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Mobile & Accessories
                                                <span class="float-end">(10,294)</span></a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Desktop <span
                                                    class="float-end">(6,256)</span></a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Electronics
                                                <span class="float-end">(3,479)</span></a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Home & Furniture
                                                <span class="float-end">(2,275)</span></a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Grocery <span
                                                    class="float-end">(1,950)</span></a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Fashion <span
                                                    class="float-end">(1,582)</span></a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Appliances
                                                <span class="float-end">(1,037)</span></a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Beauty, Toys & More
                                                <span class="float-end">(924)</span></a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Food & Drinks
                                                <span class="float-end">(701)</span></a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{url('#')}}" class="text-muted">Toys & Games
